...
import com.example.martin.forecastapp.R;

/**
 * Created by mbc on 09-05-2017.
 * This class uses weather id to retrieve gui information and textures
 */

public class WeatherIdUtils {
    public static int getDrawableIdForWeatherCondition(int weatherId, boolean isDay) {
        if(isDay)
        {
        ...
        else
        {
            if (weatherId >= 200 && weatherId <= 232) {
                ...
                return R.drawable.nt_chancerain;
            } else if (weatherId >= 500 && weatherId <= 504) {
                ...
                return R.drawable.nt_chancetstorms;
            } else if (weatherId >= 951 && weatherId <= 957) {
                return R.drawable.nt_clear;
            }
